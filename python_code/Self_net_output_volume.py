...
if __name__ == "__main__":
    ...
    test_path=r'C:/Users/fbonnet/Desktop/ryanCodeML/code/code/'
    model_path=test_path+'checkpoint/saved_models/deblur_net_40_14400.pkl'
    ...
    raw_img=tifffile.imread(test_path+'mouse_kidney/C1-kidney200um005.tif')
